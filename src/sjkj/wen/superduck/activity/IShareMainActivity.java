...
public class IShareMainActivity extends FragmentActivity {
	    ...
	    protected void onCreate(Bundle savedInstanceState) {  
	        ...
	        setContentView(R.layout.ishare_main);  
	        ...
	        StringRequest picrequest = new StringRequest(url1, new Listener<String>() {
				...
				public void onResponse(String response) {
				    ...
				    JSONArray advertiseArray = new JSONArray();
				      ...
				      llAdvertiseBoard.addView(new Advertisements(IShareMainActivity.this, true, inflater, 3000).initView(advertiseArray));
				}
	    	},new ErrorListener() {
				...
				public void onResponse(String response) {
				    ...
				    class TabPageIndicatorAdapter extends FragmentPagerAdapter {
				        ...
				        public Fragment getItem(int position) {
				        	...
				        	Bundle args = null;
				        	fragment = new IshareChildFragment();
				        	args = new Bundle();  
		...
		private void init() {  	        
	        ...
	        nbcircle_add_tpye.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					Intent intent = new Intent(IShareMainActivity.this, IshareChooseTypeActivity.class);
