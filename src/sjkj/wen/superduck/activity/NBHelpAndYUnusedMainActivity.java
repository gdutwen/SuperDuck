...
import sjkj.wen.superduck.activity.fragment.NBHelpAndYUnusedChildFragment;
import sjkj.wen.superduck.activity.global.SuperDuckApplication;
import sjkj.wen.superduck.activity.util.Advertisements;

public class NBHelpAndYUnusedMainActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.nbhelp_main);
	...
	private void initadv() {
		...
		StringRequest picrequest = new StringRequest(url1, new Listener<String>() {
			...
			public void onResponse(String response) {
				...
				llAdvertiseBoard.addView(new Advertisements(NBHelpAndYUnusedMainActivity.this, true, inflater, 3000)
			...
			public void onResponse(String response) {
				...
				class TabPageIndicatorAdapter extends FragmentPagerAdapter {
					...
					public Fragment getItem(int position) {
						...
						Bundle args = null;
						fragment = new NBHelpAndYUnusedChildFragment();
						args = new Bundle();
	...
	private void init() {
		...
		nbcircle_add_tpye.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(NBHelpAndYUnusedMainActivity.this, PLiveChooseTypeActivity.class);
