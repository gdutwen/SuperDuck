...
import sjkj.wen.superduck.activity.adapter.AdvertisementAdapter;
...
public class Advertisements implements OnPageChangeListener {
	 ...
	 private ViewPager vpAdvertise;
	   ...
	   public View initView(final JSONArray advertiseArray){
	      ...
	      vpAdvertise = (ViewPager) view.findViewById(R.id.nbcircle_adv_pager);
	      vpAdvertise.setOnPageChangeListener(this);
	      views = new ArrayList<View>();
	      LinearLayout ll = (LinearLayout) view.findViewById(R.id.nbcircle_adv_dot);//获取轮播图片的点的parent，用于动态添加要显示的点
